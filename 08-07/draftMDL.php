    ...
    <div id="base" class="">
      ...
      <div id="u397" class="ax_default" data-left="648" data-top="166" data-width="99" data-height="37">
        ...
        <div id="u3982" class="ax_default paragraph">
          <div id="u398_div" class=""></div>
          <div id="u398_text" class="text ">
            <p><span>DISALLOWANCE COST</span></p>
          </div>
        </div>
    ...
    <div id='umainbody' class='container'>
          ...
          <table class="table" style='background-color: rgba(255, 255, 255, 1);'>
            <tbody>
              ...
              <tr>
                <td>
                  <p>
                    Recipient Name: <input class="form-control form-control-sm" type="text" placeholder="" style="width:240px;">
                    </br>
                    </br>
                    Recipient fiscal or calendar year: <input class="form-control form-control-sm" type="text" placeholder="" style="width:120px;">
                    </br>
                    </br>
                    We have reviewed the single audit reports of the (recipient name) for the fiscal year ending <input class="form-control form-control-sm" type="text" placeholder="" style="width:120px;">. We performed our review in accordance with the requirements of §200.331 of the Uniform Administrative Requirements, Cost Principles, and Audit Requirements for Federal Awards, found at 2 CFR Part 200, as applicable.
                    </br>
                    </br>
                    Include this statement if a revised SEFA was requested:
                    </br>
                    </br>
                    A revised Schedule of Expenditures of Federal Awards (SEFA) was requested and recieved on (mm/dd/yy) in compliance with OAM 30.40.00 PR sction .108(g). Revisions to the SEFA were requested because (list reasons for revision).
                    </br>
                    OR,
                    </br>
                    include this paragraph if the subrecipient had a federal program audit finding where your agency was the contributing agency or an audit finidng relating to multiple federal programs:
                    </br>
                    </br>
                    The recipient's single audit include the following federal program audit findings and the corrective actions that need to be taken. (Summarize the items in this paragraph, including CFDA# and program title.) We are issuing the management decision to (recipient name) on (date of letter) in compliance with 2 CFR §200.331.
                  </p>
                </td>
              </tr>
              <tr>
                <td>
                  <p>
                    ...
                    </br>cc: All Other Contributing Agencies and their agency contact’s name
                  </p>
                </td>
              </tr>
            </tbody>
      ...
      <div class='row'>
        <div class='col'>
          ...
          <div id="u518" class="btn float-right" style="top: 5px;right: 10px;">
