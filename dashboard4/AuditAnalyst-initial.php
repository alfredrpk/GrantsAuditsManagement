...
<head>
  ...
  <title>AuditsAnalyst-initial</title>
...
<body>
  ...
  <div id="base" class="">
    ...
    <div id = "alertmsg" class="alert alert-warning alert-dismissible">           ✓ Successfully completed initial review of <strong><span id = "applicantText"></span></strong></div>
    ...
    <script>
      ...
      myEIN = urlParams.get('para2');
      document.getElementById("applicantText").innerHTML = myApplicant;
      ...
      if(parameterValue == true){
        document.getElementById("alertmsg").style.visibility = "visible";
          ...
          <!-- Unnamed (Rectangle) -->
          <div id="u56" class="ax_default paragraph1" style = "margin-top: 50px;">
            <div id="u56_div" class=""></div>
            <div id="u56_text" class="text ">
              <p><span style="font-family:'Segoe UI';font-weight:400;">Applications:</span><span style="font-family:'Segoe UI Light', 'Segoe UI Regular', 'Segoe UI';font-weight:300;"> </span><span style="font-family:'Segoe UI Semibold', 'Segoe UI Regular', 'Segoe UI';font-weight:400;">15</span></p>
            </div>
          </div>
        </div>
      </div>
...
<!-- Unnamed (Image) -->
      <!--<div id="u147" class="ax_default image">
        <img id="u147_img" class="img " src="https://d1icd6shlvmxi6.cloudfront.net/gsc/UQDAEN/33/ae/d1/33aed17b5236419da26af94a7ebc08c4/images/grants-initial/u147.png?token=dce6a34b3d893080ce1292679a6b1e3687cb5292034fb3fa1e98cd55374ca84e"/>
      </div>-->
          ...
          <div id="u204_state0_content" class="panel_state_content">
            ...
            <div id="u207" class="ax_default paragraph1" data-label="ReviewerViewLnk">
              ...
              <div id="u207_text" class="text ">
                <p><span style="font-family:'Segoe UI';font-weight:400;">Audits:</span><span style="font-family:'Segoe UI Light', 'Segoe UI Regular', 'Segoe UI';font-weight:300;"> </span><span style="font-family:'Segoe UI Semibold', 'Segoe UI Regular', 'Segoe UI';font-weight:600;">04</span></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div id="u250_state0_content" class="panel_state_content">
            ...
            <div id="u253" class="ax_default paragraph1" data-label="ReviewerViewLnk">
              ...
              <div id="u253_text" class="text ">
                <p><span style="font-family:'Segoe UI';font-weight:400;">Applications:</span><span style="font-family:'Segoe UI Light', 'Segoe UI Regular', 'Segoe UI';font-weight:300;"> </span><span style="font-family:'Segoe UI Semibold', 'Segoe UI Regular', 'Segoe UI';font-weight:600;">06</span></p>
              </div>
            </div>
